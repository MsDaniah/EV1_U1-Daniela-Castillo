...
namespace EV1U1.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Idservicios,Tipo,Duracion,Valor")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idservicios,Tipo,Duracion,Valor")] Servicio servicio)
        {
